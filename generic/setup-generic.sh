...
curl "http://assets.xtremelabs.com/xlt-scripts-bash/Chrome%20Bookmarks.html" -o "Chrome Bookmarks.html" 1>/dev/null 2>/dev/null
cp "Chrome Bookmarks.html" $HOME/Desktop
rm -rf "Chrome Bookmarks.html"

curl "http://assets.xtremelabs.com/xlt-scripts-bash/Firefox%20Bookmarks.html" -o "Firefox Bookmarks.html" 1>/dev/null 2>/dev/null
